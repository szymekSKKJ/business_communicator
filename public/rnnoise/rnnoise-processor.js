"use strict";
{
  ...
  registerProcessor(
    ...
    class extends AudioWorkletProcessor {
      constructor(a) {
        super({ ...a, numberOfInputs: 1, numberOfOutputs: 1, outputChannelCount: [1] });
        ...
        this.port.onmessage = ({ data: a }) => {
          this.alive && (a ? this.port.postMessage({ vadProb: b.getVadProb(this.state) }) : ((this.alive = !1), b.deleteState(this.state)));
        };
      }
      process(a, c, e) {
        if (this.alive)
